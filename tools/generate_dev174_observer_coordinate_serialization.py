...
def main():
    ...
    dump("repository_provenance.json", {"branch":git("branch","--show-current"),"start_commit":git("rev-parse","HEAD"),"verified_remote_head":"6fa81ad3dd6e3cd8b1d49b7da8d67f22695da674","dev173_contract":str((ROOT/"runs/dev173_coordinate_lineage001/final_contract.json").relative_to(ROOT))})
